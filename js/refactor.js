...
(function () {
  ...
  // Because of the delay from the setTimeout, the y isn't printed until after
  // the z. The x is never printed because it was updated to y before the
  // console.log call
  ...
  /* It was setting the speed to NaN when no parameter 
    was given beause when nothing is given, it passes
    undefined, and a number plus undefined is Not a 
    number.
  */
  var speed = 0;
